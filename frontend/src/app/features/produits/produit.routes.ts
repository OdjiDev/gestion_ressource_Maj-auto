...
export const PRODUIT_ROUTES: Routes = [
  ...
  {
    path: 'create',
    loadComponent: () => import('./pages/produit-create/produit-create').then(m => m.ProduitCreate),
    title: 'Nouveau produit'
  },
  {
    path: 'update/:id',
    loadComponent: () => import('./pages/produit-update/produit-update').then(m => m.ProduitUpdate),
